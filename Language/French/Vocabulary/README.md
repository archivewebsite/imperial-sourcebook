...
`Vocabulary` stores French-Indonesian and Indonesian-French translated-word dictionaries for language review.

## What Belongs Here

- French-Indonesian vocabulary tables
- Indonesian-French vocabulary tables
...
- keep this folder only for French-Indonesian and Indonesian-French vocabulary
