...
title: "Manage notes"
site: "Obsidian Help"
source: "https://obsidian.md/help/manage-notes"
domain: "obsidian.md"
language: "en"
description: "You can manage files and folders in several ways, using Hotkeys, commands, or File explorer. Create a new note To create a new file: 1. Press Ctrl+N (or Cmd+N on macOS). Enter the name of the note an…"
word_count: 319
---
