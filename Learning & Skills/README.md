...
- `How I Learned X`: retrospectives on how a topic or skill was learned.
- `Language Vaults`: language-focused learning material.
- `Skill Trees`: maps of skills, prerequisites, and next steps.
- `Spaced Repetition Source`: notes worth converting into drills or cards.
