![[Pasted image 20260412095126.png]]
...
Neuroscientists call it **dispersion**. And your dopamine system fights you every time you try to follow that "just focus" advice.
...
![[Pasted image 20260412095208.png]]
...
![[Pasted image 20260412095317.png]]
...
This is why success specifically triggers the urge to scatter: **once your brain learns to expect a reward, dopamine stops firing at the reward itself and only fires at the cue that predicts it.** The better things are going, the louder the pull toward something new. That's dispersion at the neurochemical level.

![[Pasted image 20260412095341.png]]

And if you're entrepreneurial, you're even more at risk. Based on the Big Five personality traits, entrepreneurs tend to score high in **Openness to Experience** — the very trait that makes you good at starting things makes you bad at sticking with them. Your brain is more sensitive to novelty, which means the anticipatory dopamine hit from a new pursuit is even stronger for you than for the average person.

Three cognitive biases stack on top of this: 
*   **Novelty bias** (chasing new pursuits before mastering current ones)
*   **Scarcity bias** (anxiety about missing limited opportunities)
*   **Present bias** (overvaluing immediate wins over long-term compounding)

Together with the dopamine mechanics, they keep you locked in explore mode when you should be exploiting.
...
2.  **Environmental novelty:** If your work is location-independent and you've been in the same city for years, move. Or book month-long stays in unfamiliar places. Take on a physical project you've been avoiding — a workshop renovation, a vehicle restoration. New environments create uncertainty, which triggers dopamine. Give your nervous system the novelty it craves without touching your business.
3.  **High-flow pursuits with real failure risk:** Pick one pursuit that triggers flow outside your business. Three times per week, ninety minutes per session. The activity needs immediate feedback, clear goals, and escalating challenge. Brazilian jiu-jitsu. Rock climbing. Competitive tennis. Learning piano. Here's the filter: can you fail at it? If there's no meaningful risk of failure, it won't generate sufficient dopamine. Disc golf works better than walks. Climbing works better than the gym.

Flow also has a carryover effect. When you access flow in one domain, it becomes easier to access in other domains. A high-flow lifestyle protects a low-flow business phase.
...
![[Pasted image 20260412095357.png]]
