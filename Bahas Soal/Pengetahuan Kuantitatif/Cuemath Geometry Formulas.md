...
- Area of a Trapezoid = ½ × (base <sub>1</sub> + base <sub>2</sub>) × height
- Area of a Circle = A = π×r <sup>2</sup>
...
- Volume of a Cylinder = V = πr <sup>2</sup> h
- The curved surface area of a cone = πrl
- Total surface area of a cone = πr(r+l) = πr\[r+√(h <sup>2</sup> +r <sup>2</sup>)\]
- Volume of a Cone = V = ⅓×πr <sup>2</sup> h
- Surface Area of a Sphere = S = 4πr <sup>2</sup>
- Volume of a Sphere = V = 4/3×πr <sup>3</sup>
...
| SHAPES | FORMULAS |
| --- | --- |
| 1\. Right Triangle | Pythagoras Theorem: base <sup>2</sup> + height <sup>2</sup> = hypotenuse <sup>2</sup>  Area = ½ × base × height  Perimeter = base + height + hypotenuse |
| 2\. Triangle | Perimeter, P = a + b + c  Where, a, b, and c are the sides of a triangle.  Area, A = ½ base × height |
| 3\. Rectangle | Perimeter = 2(l + w)  Area = lw  Diagonal, d = √(l <sup>2</sup> + w <sup>2</sup>)  Where,  l = length of a rectangle  w = width of a rectangle |
...
| 6\. Circle | Circumference = 2πr  Area = πr <sup>2</sup>  Diameter = 2r  Where,  r = radius of a circle |
| 7\. Square | Perimeter, P = 4a  Area, A = a <sup>2</sup>  Diagonal, d = a√2  Side, a = √A  Where,  a = side of a square |
| 8\. Arc | Arc Length, L = rθ  Here, θ is the central angle in radians and r = radius |
| 9\. Cube | Area, A = 6a <sup>2</sup>  Volume, V = a <sup>3</sup>  Edge, a = Volume <sup>⅓</sup>  Space diagonal = a√3  Where,  a = side of a cube |
| 10\. Cuboid | Surface Area, A = 2(lb + bh + hl)  Volume, V = lbh  Space diagonal, d = √( l <sup>2</sup> + b <sup>2</sup> +h <sup>2</sup>)  Where,  l= length  b= breadth  h= height |
| 11\. Cylinder | Total Surface Area, A = 2πrh + 2πr <sup>2</sup>  Curved Surface Area, A <sub>c</sub> = 2πrh  Volume, V = πr <sup>2</sup> h  Base Area, A <sub>b</sub> = πr <sup>2</sup>  Radius, r = √(V/πh)  Where,  r= radius of a cylinder  h= height of a cylinder |
| 12\. Cone | Total Surface Area, A = πr(r+l) = πr\[r+√(h <sup>2</sup> +r <sup>2</sup>)\]  Curved Surface Area, A <sub>c</sub> = πrl  Volume, V = ⅓πr <sup>2</sup> h  Slant Height, l = √(h <sup>2</sup> +r <sup>2</sup>)  Base Area, A <sub>b</sub> = πr <sup>2</sup>  Where,  r= radius of a cone  h= height of a cone  l = slant height |
| 13\. Sphere | Surface Area, A = 4πr <sup>2</sup>  Volume, V = ⁴⁄₃πr <sup>3</sup>  Diameter = 2r  Where,  r= radius of a sphere |
...
Area of circle = π × r <sup>2</sup>

\= 3.142857 × 21 <sup>2</sup>
...
**Answer: The area of the rectangular park is 5400 m <sup>2</sup>.**
...
- Space diagonal of cuboid, d = √(l <sup>2</sup> + b <sup>2</sup> +h <sup>2</sup>)
...
- Diagonal of a rectangle, d = √(l <sup>2</sup> + w <sup>2</sup>)
...
- Total surface area of cone, A = πr(r+l) = πr\[r+√(h <sup>2</sup> +r <sup>2</sup>)\]
- Curved surface area of cone, A <sub>c</sub> = πrl
- Volume of cone, V = ⅓πr <sup>2</sup> h
- Slant Height of cone, l = √(h <sup>2</sup> +r <sup>2</sup>)
- Base Area, A <sub>b</sub> = πr <sup>2</sup>
...
The two important geometry formulas of a sphere are the area and volume of a sphere. The formula for the surface area of a sphere is A = 4πr <sup>2</sup> and the formula for the volume of the sphere is V = ⁴⁄₃πr <sup>3</sup>.
