---
title: "How to Monetize Your AI Skills (outside of your 9–5 job)"
author: "Shaw Talebi"
site: "The Data Entrepreneurs"
published: 2025-11-05T17:04:09Z
source: "https://medium.com/the-data-entrepreneurs/how-to-monetize-your-ai-skills-outside-of-your-9-5-job-9b2514625762"
domain: "medium.com"
language: "en"
description: "5 technical side-hustles you can start this weekend"
word_count: 1345
---
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*QC0ZV15RZFDYiGbG)
...
1. **Referrals**: letting people in your network know that you’re looking for contract work
2. **Upwork**: a freelancing platform where you can apply to gigs directly
...
## [How to Freelance as a Data Scientist](https://medium.com/the-data-entrepreneurs/how-to-freelance-as-a-data-scientist-ca9182999595?source=post_page-----9b2514625762---------------------------------------)
...
## [From 0 to 70k: My (Technical) Content Creation Journey](https://medium.com/the-data-entrepreneurs/from-0-to-70k-my-technical-content-creation-journey-bdc1559976a0?source=post_page-----9b2514625762---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*4sMslqRKo2wnJMI8qt9PbQ.png)

My old consulting funnel.
...
1. **Self-paced courses**: think Udemy-style courses ranging from $10-$300
2. **Live, cohort-based courses**: more like a traditional classroom since sessions are live, with a high ticket price point i.e. $500-$5,000
3. **Live trainings for companies**: similar to previous modality, but the customers are businesses instead of individuals, which means even higher prices i.e. $5,000-$50,000
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*xTWn2mGu8AuuC_hYmwV-Ew.png)

My current AI education funnels. (Left) live, cohort-based course on Maven. (Right) live AI trainings for companies.
...
I’m currently on this journey (without a full-time salary) and of the two products I’ve built, **I’ve made a whopping $45**. I talk more about my experience in these posts: [SaaS 1](https://medium.com/the-data-entrepreneurs/i-built-an-ai-app-in-4-days-heres-how-i-did-it-2eb805783377?sk=b64c776e5cfd4439f38a50b5fa4b13c9), [SaaS 2](https://medium.com/the-data-entrepreneurs/what-i-learned-launching-an-ai-saas-in-30-days-ab9a49d38689?sk=a89d4b02a400e75162ce077791b174e8)

## [What I Learned Launching an AI SaaS (in 30 days)](https://medium.com/the-data-entrepreneurs/what-i-learned-launching-an-ai-saas-in-30-days-ab9a49d38689?source=post_page-----9b2514625762---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*gxWn6OQa-WixKCVNErcxzw.png)

Income vs effort plot. Effort = the estimated hours per dollar. Axes are log scale.

Here are the raw data for the plot above.

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*14Hwio45fh_NvNmPeNjnmw.png)

Earnings, effort, and est. hourly rate of my entrepreneurial ventures.
...
💻 Get 30 (free) AI project ideas: [https://30aiprojects.com/](https://30aiprojects.com/)
