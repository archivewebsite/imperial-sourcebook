![](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*_qNL25isYWV562VWNx-2sw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*ti-2rP9B1ONEE6Z1)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*qrmewYwYAwpsEwAf)

Source: Author

*And what do those numbers mean?* In isolation, not much. **But relative to other tokens, they mean a lot**.
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*I9orGo9uLMKs_wSP.png)

[Source](https://www.kolena.com/)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*5FVm1yCVJjmxqR7ik_a_9Q.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*L6ymi47j1-bynvAbTn5OLQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*suzhMMMXxD91YXC35Osy4w.png)
...
When you send ‘ *What’s today’s news on the Iran war?*’ to ChatGPT, these words are broken down into tokens and fed to the model only then.

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*SMIdoKGGo5dyEyqMyzihsg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*m6zW6NKQIdlQ2VnJka9hyA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*poo-cKpm6i4pH3LueUMj3Q.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Ign2Y92O_ZxnPrk9bgh38w.png)
...
## [Subscribe | TheWhiteBox by Nacho de Gregorio](https://thewhitebox.beehiiv.com/subscribe?source=post_page-----22f009da22bd---------------------------------------)
...
*Revenues?* At best, **at $100 billion a year for all companies in the mix** (of course, excluding Hyperscaler revenues, which are mostly circular and no real money is actually being transacted).
...
*Is that a trillion-dollar market?* Let’s just hope it is, because otherwise all these companies are spending billions only for enterprises to say, ‘yeah, thanks, but we’re going with the open-source solution that exists because of you, but it’s much, much cheaper than you are.’

Because thinking frontier AIs, which, in my honest opinion, **will continue to rise in price for years**, can be automation tools that can be profitably used to read your emails, ==is like== ==*“killing flies with cannonballs”*====, as my grandfather used to say,== is absolute lunacy.

> I share similar thoughts in a more comprehensive and simplified manner on my [LinkedIn](https://www.linkedin.com/in/ignacio-de-gregorio-noblejas/) (don’t worry, no AI-generated content there either). As a reminder, you can also [subscribe to my newsletter](https://thewhitebox.beehiiv.com/subscribe), and follow my enterprise-AI focused [Medium](https://medium.com/@theimperative) and [Substack](https://substack.com/@theimperativeai).
