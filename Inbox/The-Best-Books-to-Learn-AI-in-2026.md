...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*bVlppsH6-T1eUxbg)

Photo by Thought Catalog on Unsplash

> *You can* [*read this article for free here*](https://artificialcorner.com/p/ai-books)
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*iZ6L02-kTsFIHZtG.jpeg)
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*KA6DwKVgqwQmnZr8uZQJcQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*mrDhZa7DcCBMNyUB.jpeg)
...
> *🎁* ***FREE ChatGPT Course****: As a thank you for reaching 140k+ followers, I’m offering my ChatGPT course for free.* [*Get it here*](https://artificialcorner.com/p/chatgpt-course)

## #4 Prompt Engineering for Generative AI (by James Phoenix and Mike Taylor)

![](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*6xZc6ROPQX6ez-dn.jpeg)
...
1. Give Direction: Describe the desired style or reference a relevant persona
2. Specify Format: Define the rules and required structure of the response (e.g., JSON, YAML)
3. Provide Examples: Insert a diverse set of test cases showing correct task completion
4. Evaluate Quality: Identify errors and rate responses to optimize performance
5. Divide Labor: Split complex goals into multiple steps or chained tasks
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*0voNQxTIzfVs56dv.jpeg)
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*LhLigRbkry-3i43j.jpeg)
...
If you have a book recommendation, write it in the comments!
