...
| 1. | [What is the Area of a Triangle?](#what) |
| --- | --- |
| 2. | [Area of Triangle Formula](#ATF) |
| 3. | [Area of Triangle Using Heron's Formula](#HF) |
| 4. | [Area of Triangle With 2 Sides and Included Angle](#sas) |
| 5. | [How to Find the Area of a Triangle?](#HCAT) |
| 6. | [FAQs on Area of Triangle](#faqs) |

## What is the Area of a Triangle?

The **area of a triangle** is the region enclosed within the sides of the triangle. The area of a triangle varies from one triangle to another depending on the length of the sides and the internal angles. The area of a triangle is expressed in square units, like, m <sup>2</sup>, cm <sup>2</sup>, in <sup>2</sup>, and so on.
...
**Solution:** Using the formula: Area of a Triangle, A = 1/2 × b × h = 1/2 × 4 × 2 = 4 cm <sup>2</sup>
...
Area = √s(s−a)(s−b)(s−c) $s(s−a)(s−b)(s−c)$ $\sqrt {s(s - a)(s - b)(s - c)}$
...
Area of an Equilateral Triangle = A = (√3)/4 × side <sup>2</sup>
...
| When the sides of a triangle are given as a, b, and c. | (Heron's formula)  Area of a scalene triangle = √s(s−a)(s−b)(s−c) $s(s−a)(s−b)(s−c)$ $\sqrt {s(s - a)(s - b)(s - c)}$      where a, b, and c are the sides and 's' is the semi-perimeter; s = (a + b + c)/2 |
...
| When it is an equilateral triangle and one side is given. | Area of an equilateral triangle = (√3)/4 × side <sup>2</sup> |
| When it is an isosceles triangle and an equal side and base is given. | Area of an isosceles triangle = 1/4 × b √4a2−b2 $4a2−b2$ $\sqrt {4{a^2} - {b^2}}$      where 'b' is the base and 'a' is the length of an equal side. |
...
1. **Example 1:** Find the area of a triangle with a base of 10 inches and a height of 5 inches.
	**Solution:**
...
The **area of a triangle** is the space enclosed within the three sides of a triangle. It is calculated with the help of various formulas depending on the type of triangle and is expressed in square units like, cm <sup>2</sup>, inches <sup>2</sup>, and so on.
...
- Area of a scalene triangle = √s(s−a)(s−b)(s−c) $s(s−a)(s−b)(s−c)$ $\sqrt {s(s - a)(s - b)(s - c)}$; where a, b, and c are the sides and 's' is the semi-perimeter; s = (a + b + c)/2
...
The area of a triangle can be calculated when only the length of the 3 sides of the triangle are known and the height is not given. In this case, the Heron's formula can be used to find the area of the triangle. Heron's formula: A = √s(s−b)(s−b)(s−c) $s(s−b)(s−b)(s−c)$ $\sqrt {s(s - b)(s - b)(s - c)}$ where a, b, and c are the sides of the triangle and 's' is the semi-perimeter; s = (a + b + c)/2.
...
The area of a triangle with 3 sides can be calculated using Heron's formula. Heron's formula: A = √s(s−a)(s−b)(s−c) $s(s−a)(s−b)(s−c)$ $\sqrt {s(s - a)(s - b)(s - c)}$ where a, b, and c are the sides of the triangle and 's' is the semi-perimeter; s = (a + b + c)/2.
